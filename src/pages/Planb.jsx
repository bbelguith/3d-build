                        ...
                        >
                            ...
                            <div className="mt-auto relative z-10 p-10 text-white w-full">
                                ...
                                <div className="flex items-center gap-2 mt-4">
                                    {twinPlanImages.map((_, idx) => (
                                        <button
                                            key={idx}
                                            onClick={(e) => { e.stopPropagation(); setTwinPlanIdx(idx); }}
                                            className={`h-2.5 rounded-full transition-all duration-300 shadow-sm ${idx === twinPlanIdx ? "w-8 bg-white" : "w-3 bg-white/40 hover:bg-white/80"}`}
                                        />
                                    ))}
                                </div>
                            </div>
