...
export default function Plan() {
    ...
    const currentActiveId = hoveredHouseId ?? (activeHouses[currentIdx] ? activeHouses[currentIdx].id : null);
    ...
    const Title = ({ children }) => (
        <div className="text-center max-w-5xl mx-auto px-4 mb-8 relative"> {/* Reduced mb-16 to mb-8 */}
                ...
                <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-8">
                    <div className="flex flex-col lg:flex-row gap-6 items-stretch">
                        ...
                        <div className="lg:w-[260px] bg-white/80 border border-white/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-3xl p-8 flex flex-col justify-between backdrop-blur-xl transition-all hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] hover:-translate-y-1">
                            <div>
                                <h2 className="text-4xl font-serif font-bold mb-2 text-gray-900">Unit 1R</h2>
                                <p className="text-xs font-bold text-emerald-600 uppercase tracking-widest mb-6">Available Now</p>
                                <div className="space-y-4 text-sm text-gray-600">
                                    <div className="flex justify-between border-b border-dashed border-gray-200 pb-2">
                                        <span className="font-medium">Total Area</span>
                                        <span className="font-serif text-gray-900">546 sqft</span>
                                    </div>
                                    <div className="flex justify-between border-b border-dashed border-gray-200 pb-2">
                                        <span className="font-medium">Price</span>
                                        <span className="font-serif text-emerald-700 font-bold text-lg">$1.02M</span>
                                    </div>
                                </div>
                            </div>
                  ...
                  `}>
                        ...
                        {/* Added pb-16 to ensure bottom content isn't cut off by rounded corners */}
                        <div
                        ...
                        >
                            ...
                            {/* Content moved to ensure it's above everything and has padding */}
