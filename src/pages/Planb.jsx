    ...
    return (
        <div className="h-full text-gray-800 bg-[#fdfdfd] pb-32">
            ...
            <section ref={selectionRef} className="relative z-10 w-full flex flex-col items-center justify-start gap-12 pt-24 bg-white pb-32">
                ...
                <div className="relative w-full max-w-[1600px] h-[75vh] rounded-t-[4rem] overflow-hidden shadow-2xl mx-auto mt-auto border-t-8 border-x-8 border-white bg-gray-100">
                    <div
                        key={currentImage}
