...
// --- ICONS ---
const PdfIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.2} stroke="currentColor" className="w-5 h-5 mb-1">
...
export default function Plan() {
    ...
    const twinPlanLabels = ["Ground Floor", "1st Floor", "Terrace"];
            ...
            <section className="pt-20 pb-24 border-b border-gray-100 relative z-10">
                ...
                <div className="max-w-[1800px] mx-auto px-6 lg:px-16">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                        ...
                        {/* CENTER COLUMN: The Twin Plan Image (Inside Card Wrapper) */}
                        <div className="lg:col-span-6 flex flex-col items-center justify-center">
                            ...
                            <div className="bg-white p-8 lg:p-12 rounded-[3rem] shadow-xl border border-gray-100 w-full flex flex-col items-center relative z-20">
                                ...
                                >
                                    {/* UPDATED: Added rotate-90 to flip image horizontally, removed hover scale */}
                                    <img
                                ...
                                {/* High visibility buttons - Nested inside card with subtle background */}
